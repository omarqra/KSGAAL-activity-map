        ...
        <div className="relative mt-7 w-full">
          ...
          <div className="rounded-md border border-[#e7e0cc] bg-white px-6 py-7 shadow-[0_1px_2px_0_rgba(13,68,41,0.04),0_12px_28px_-14px_rgba(13,68,41,0.18)] sm:px-8">
            <div className="mb-6 flex items-center justify-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#e7e0cc] bg-[#faf7ee] px-3.5 py-1.5 font-mono text-[13px] font-semibold tabular-nums text-[#082F18]">
                <span
                  aria-hidden
                  className="inline-block h-1.5 w-1.5 rounded-full bg-[#D56028]"
                />
                <CountDown />
              </div>
            </div>
